...
VALUES (NULL, '82198127000121', CURRENT_DATE(), CURRENT_DATE(), 'drSolutions IT');
...
VALUES (NULL, '16248890935', CURRENT_DATE(), CURRENT_DATE(), 'admin@drsolutions.com,br', 'ADMIN', 'ROLE_ADMIN', NULL, NULL, 
